 ...
 * @author DCN
 */
public class ApplyLeaveStu extends javax.swing.JFrame {
    int rollno;
    /**
     * Creates new form ApplyLeaveStu
     */
    public ApplyLeaveStu() {
        initComponents();
    }
    
    public ApplyLeaveStu(int n)
    {
        initComponents();
        rollno = n;
        fetchDetails();
    ...
    private void initComponents() {
        ...
        tfRollNo.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        tfRollNo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(6, 20, 27)));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tfRollNo, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel6)
                            .addComponent(tfRollNo, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel15)
    ...
    private void btnCheckStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckStatusActionPerformed
        String sql = "select status from leave_request_stu where rollno = ?";
        try {
            // TODO add your handling code here:
            ...
            Logger.getLogger(ApplyLeaveStu.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApplyActionPerformed
        // TODO add your handling code here:
        String sql = "insert into leave_request_stu (name, rollno, num_of_days, date, reason) values (?, ?, ?,?, ?)";
        
        if(tfName.getText().isEmpty() || tfRollNo.getText().isEmpty() || tfNumOfDays.getText().isEmpty() || tfDate.getText().isEmpty() || taReason.getText().isEmpty())    
        {
        ...
        try {
            ...
            pst.setString(2, tfRollNo.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplyLeaveStu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApplyLeaveStu().setVisible(true);
            }
        });
    }
